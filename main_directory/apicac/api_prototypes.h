...
void cac_get_omega1_omega2(int *return_code, int *omega1_size, double **omega1_coord, int *omega2_size, double **omega2_coord, int contour_size, double *contour_coord, int ncol, int nrow, int band_size);
