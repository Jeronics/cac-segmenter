...
class MeanMultiCAC(CAC):
    def energy(self, omega_1_coord, omega_2_coord, affine_omega_1_coord, affine_omega_2_coord):
        ...
        for slice, (t, w) in enumerate(zip(self.type, self.weight)):
            omega_1 = multi_mean_energy.generic_mean_energy_per_region(omega_1_coord, affine_omega_1_coord, self.image_obj,
                                                                       t, slice)
            omega_2 = multi_mean_energy.generic_mean_energy_per_region(omega_2_coord, affine_omega_2_coord, self.image_obj,
                                                                       t, slice)
...
if __name__ == '__main__':
    ...
    results_folder = 'segment_results_alpert_4/' + rgb_cac.CAC.__name__
