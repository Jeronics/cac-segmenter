...
if __name__ == '__main__':
    ...
    dataset = multivariate_gaussian_gray_cac.load_dataset('AlpertGBB07_input_2.txt')
    results_folder = 'segment_results_alpert_5/' + multivariate_gaussian_gray_cac.CAC.__name__
